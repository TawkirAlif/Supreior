...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[995, 209, 745, 120, 192, 520, 181, 791, 268, 357], {
	...
	5966: (e, t, n) => {
		n(2109),
		e.exports = n(7252).Object.getOwnPropertyDescriptors
	},
	9406: (e, t, n) => {
		n(5638),
		e.exports = n(7252).Object.getOwnPropertySymbols
	},
	9485: (e, t, n) => {
		n(8970),
		n(617),
		...
		var r,
			...
			onUnhandled = function(e) {
				y.call(l, (function() {
					...
					})), e._h = P || isUnhandled(e) ? 2 : 1), e._a = void 0, a && t.e)
						throw t.v
				}))
			},
	...
	2109: (e, t, n) => {
		...
		r(r.S, "Object", {
			getOwnPropertyDescriptors: function getOwnPropertyDescriptors(e) {
				for (var t, n, r = a(e), l = o.f, u = i(r), c = {}, f = 0; u.length > f;)
				...
				return (0, a.default)(baseTabs, [{
					...
					value: function bindEvents() {
						...
						this.elements.$tabTitles.on({
							keydown: function keydown(t) {
								jQuery(t.target).is("a") && "Enter" === t.key && t.preventDefault(),
								["End", "Home", "ArrowUp", "ArrowDown"].includes(t.key) && e.handleKeyboardNavigation(t)
							},
					...
					value: function onInit() {
						for (var e, t = arguments.length, n = new Array(t), r = 0; r < t; r++)
							n[r] = arguments[r];
						(e = (0, o.default)((0, s.default)(baseTabs.prototype), "onInit", this)).call.apply(e, [this].concat(n)),
					...
					value: (t = (0, a.default)(i.default.mark((function _callee() {
						...
						return i.default.wrap((function _callee$(i) {
							for (;;)
								...
								case 0:
									for (t = s.length, n = new Array(t), r = 0; r < t; r++)
										n[r] = s[r];
								...
								case 8:
									...
									"yes" === a.pause_on_hover && this.togglePauseOnHover(!0);
								case 11:
								case "end":
									return i.stop()
								}
			...
			c = function(e) {
				...
				return (0, a.default)(TextEditor, [{
					...
					value: function onInit() {
						for (var e, t = arguments.length, n = new Array(t), r = 0; r < t; r++)
							n[r] = arguments[r];
						(e = (0, o.default)((0, s.default)(TextEditor.prototype), "onInit", this)).call.apply(e, [this].concat(n)),
						this.wrapDropCap()
					}
				}, {
					key: "onElementChange",
				...
				return (0, a.default)(Video, [{
					...
					value: function playVideo() {
						if (this.elements.$video.length)
							this.youtubePlayer ? this.youtubePlayer.playVideo() : this.elements.$video[0].play();
						else {
		...
		n(8897)("replace", 2, (function(e, t, n, v) {
			return [function replace(r, i) {
				...
				for (var b, w = "", _ = 0, x = 0; x < y.length; x++) {
					m = y[x];
					for (var k = String(m[0]), S = u(c(o(m.index), d.length), 0), E = [], T = 1; T < m.length; T++)
			...
			function maybeInvokeDelegate(e, n) {
				...
				if (r === t) {
					if (n.delegate = null, "throw" === n.method) {
						if (e.iterator.return && (n.method = "return", n.arg = t, maybeInvokeDelegate(e, n), "throw" === n.method))
							return d;
						n.method = "throw",
			...
			return GeneratorFunction.prototype = g.constructor = GeneratorFunctionPrototype, GeneratorFunctionPrototype.constructor = GeneratorFunction, GeneratorFunction.displayName = define(GeneratorFunctionPrototype, s, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
				...
				finish: function(e) {
					for (var t = this.tryEntries.length - 1; t >= 0; --t) {
						...
						if (n.finallyLoc === e)
							return this.complete(n.completion, n.afterLoc), resetTryEntry(n), d
					}
				},
				catch: function(e) {
					for (var t = this.tryEntries.length - 1; t >= 0; --t) {
